...
class EditDistance {
	...
	static int editDistance_Memorization(String S1, String S2) {
		int n = S1.length();
		int m = S2.length();
	...
	static int editDistance_Space(String S1, String S2) {
		int n = S1.length();
		int m = S2.length();
	...
	public static void main(String args[]) {
		...
		System.out.println("The minimum number of operations required is: " + editDistance_Memorization(s1, s2));
	}
}
